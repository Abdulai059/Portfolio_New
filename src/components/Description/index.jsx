			...
			<div ref={description} className={styles.description}>
				<div className={styles.body}>
					...
					<motion.p
						...
						animate={isInView ? 'open' : 'closed'}
					>
						Other than that, I like Anime, Web3 gaming, Art Designs,
						e-Sports. I balance screen time by working out and playing football, always focused on learning and leveling up in real life.
					</motion.p>
					<div id="about">
						<Magnetic>
							<div
