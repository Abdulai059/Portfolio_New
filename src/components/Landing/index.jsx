...
export default function Home() {
	...
	useEffect(() => {
		const updateTime = () => {
			const ghanaTime = new Date().toLocaleTimeString('en-GH', {
	...
	return (
		<motion.main
			...
			id="home"
		>
			<Image src="/images/bg.png" fill={true} alt="background" priority />
			<div className={styles.sliderContainer}>
				<div ref={slider} className={styles.slider}>
					<p ref={firstText}>Zesung Usumanu —</p>
					<p ref={secondText}>Zesung Usumanu —</p>
				</div>
			</div>
			<div
				data-scroll
